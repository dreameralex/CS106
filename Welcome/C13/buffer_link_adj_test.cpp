...
void executeCommand(EditorBuffer_Link_Adj & buffer, string line);

void displayBuffer(EditorBuffer_Link_Adj & buffer);

void printHelpText2();

int main_C13_buffer_adj(){
    EditorBuffer_Link_Adj buffer;
    printHelpText2();
...
void executeCommand(EditorBuffer_Link_Adj & buffer, string line){
    ...
    case 'H': buffer.moveCursorToEnd();printHelpText2(); break;
    case 'Q': exit(0);
